...
const Support: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
      <div className="max-w-[1000px] mx-auto flex flex-col gap-4 md:gap-6 lg:gap-8">
        {/* Header */}
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-slate-900">Support / Help</h1>
          <p className="text-slate-500 text-xs md:text-sm mt-1">Get help and find answers to common questions</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
          {/* Contact Form */}
          <div className="bg-white rounded-xl border border-slate-200 p-4 md:p-6">
            <h3 className="font-bold text-base md:text-lg text-slate-900 mb-3 md:mb-4 flex items-center gap-2">
            ...
            {submitted ? (
              <div className="py-8 md:py-12 text-center">
                <div className="size-14 md:size-16 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
                  <span className="material-symbols-outlined text-2xl md:text-3xl">check_circle</span>
                </div>
                <p className="text-base md:text-lg font-semibold text-slate-900">Message Sent!</p>
                <p className="text-slate-500 text-xs md:text-sm mt-1">We'll get back to you soon.</p>
              </div>
            ) : (
